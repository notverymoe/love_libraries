...
local sardine = require("sardine.entity")

---@class luassert
---@field message fun(string): luassert.internal

describe("GenIdAllocator", function()
    it("should allocate in a sequence", function()
        local alloc = sardine.GenIdAllocator.new()
